...
class Server(models.Model):
    ...
    def update(cls, xmldoc, monit_id):
        ...
        for service in xmldoc.getElementsByTagName('services')[0].getElementsByTagName('service'):
            ...
            # we call everything else a Process
...
class Net(Service):
    ...
    def update(cls, xmldoc, server, service):
        ...
        net.status_hint = get_value(service, "status_hint", "")
        net.monitor = get_value(service, "monitor", "")
        net.monitormode = get_value(service, "monitormode", "")
        net.pendingaction = get_value(service, "pendingaction", "")
        net.save()
