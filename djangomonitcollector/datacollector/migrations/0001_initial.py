...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='monitevent',
            name='server',
            field=models.ForeignKey(to='datacollector.Server'),
        ),
        migrations.AddField(
            model_name='monitevent',
            name='service',
            field=models.ForeignKey(to='datacollector.Service'),
        ),
        migrations.AddField(
            model_name='netstats',
            name='net_id',
            field=models.ForeignKey(to='datacollector.Net'),
        ),
        migrations.AddField(
            model_name='memorycpusystemstats',
            name='system_id',
            field=models.ForeignKey(to='datacollector.System'),
        ),
        migrations.AddField(
            model_name='memorycpuprocessstats',
            name='process_id',
            field=models.ForeignKey(to='datacollector.Process'),
        ),
        migrations.AddField(
            model_name='fsanddiskusagestats',
            name='fs_id',
            field=models.ForeignKey(to='datacollector.FileSystem'),
        ),
    ]
